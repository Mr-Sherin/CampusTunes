...
import { X, Play, Pause, Music, Trash2, ListMusic, Download } from "lucide-react";
...
export function QueueDrawer() {
  ...
  const handleRemoveFromQueue = (e: React.MouseEvent, songId: string) => {
    e.stopPropagation();
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        setDownloadTargetSong(song);
                      }}
                      className="p-1.5 text-on-surface-variant hover:text-primary opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"

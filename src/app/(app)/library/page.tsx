...
export default function LibraryPage() {
  ...
  const handlePlayAll = (songList: Song[], shuffle = false) => {
          ...
          <div className="p-3.5 rounded-2xl bg-[#121024] border border-white/[0.08] text-left space-y-2.5 text-xs text-white/85 max-w-sm mx-auto">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-on-surface-variant">Curate study jams, gym playlists, and club anthems.</p>
              </div>
            </div>
          </div>
    ...
    <div className="space-y-8 pb-16 select-none max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/[0.08]">
        <div className="flex items-center gap-3.5">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-violet-600 to-cyan-500 p-0.5 shadow-[0_0_25px_rgba(168,85,247,0.35)]">
            <div className="w-full h-full bg-[#0c0a18] rounded-[14px] flex items-center justify-center text-primary">
              <LibraryIcon size={22} />
            </div>
          </div>
          <div>
            <h1 className="font-display text-3xl font-black text-white tracking-tight">Your Collection</h1>
            <p className="text-xs text-on-surface-variant">Permanent liked songs, custom college mixes, & playlists</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-auto">
          <button
            ...
            className="px-4 py-2 rounded-full bg-gradient-to-r from-violet-600 to-cyan-500 hover:opacity-95 text-white text-xs font-bold flex items-center gap-1.5 shadow-[0_0_15px_rgba(168,85,247,0.3)] transition-all active:scale-95 cursor-pointer"
          >
            <Plus size={15} /> New Playlist
          </button>

          <div className="flex items-center gap-1 bg-[#121024] p-1 rounded-full border border-white/10">
            <button
              onClick={() => setViewMode("list")}
              className={`p-1.5 rounded-full transition-colors cursor-pointer ${
                viewMode === "list" ? "bg-primary text-white" : "text-on-surface-variant hover:text-white"
              }`}
              title="List view"
            >
              <List size={15} />
            ...
            <button
              ...
              className={`p-1.5 rounded-full transition-colors cursor-pointer ${
                viewMode === "grid" ? "bg-primary text-white" : "text-on-surface-variant hover:text-white"
              }`}
              title="Grid view"
            >
              <Grid size={15} />
      ...
      <div className="flex items-center justify-between border-b border-white/[0.08] pb-3 gap-4">
        <div className="flex items-center gap-2.5">
          <button
            onClick={() => {
              setActiveTab("liked");
            ...
            className={`flex items-center gap-2 text-xs md:text-sm font-bold px-5 py-2.5 rounded-full transition-all cursor-pointer ${
              activeTab === "liked" && !selectedPlaylistId
                ? "bg-primary text-white shadow-lg shadow-primary/30"
                : "text-on-surface-variant hover:text-white hover:bg-white/[0.05]"
            }`}
          >
            <Heart size={14} className={activeTab === "liked" && !selectedPlaylistId ? "fill-white" : ""} />
        ...
        <div className="relative hidden md:block w-56">
          ...
          <input
            ...
            className="w-full bg-[#121024] border border-white/10 rounded-full pl-9 pr-3 py-1.5 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-primary"
          />
        </div>
      </div>
      ...
      {activeTab === "liked" && !selectedPlaylistId && (
        <div className="space-y-6">
          ...
          <div className="relative rounded-3xl overflow-hidden p-8 bg-gradient-to-r from-violet-950/60 via-[#16122d] to-[#0c0a18] border border-white/15 shadow-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div className="space-y-2">
              <span className="text-[10px] font-bold uppercase tracking-widest text-pink-400 flex items-center gap-1.5">
                <Sparkles size={13} /> Permanent Collection
              </span>
              <h2 className="font-display text-3xl md:text-4xl font-black text-white">Liked Songs</h2>
                    ...
                    >
                      ...
                      <div className="col-span-5 sm:col-span-2 flex items-center justify-end gap-3">
                        <button
                          ...
                          className="text-on-surface-variant hover:text-primary p-1.5 transition-colors cursor-pointer"
                    ...
                    {editingName ? (
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-emerald-500 text-black hover:opacity-90 cursor-pointer"
                        >
                          <Check size={16} />
                        </button>
                        <button
      ...
      <DownloadModal
        ...
        isOpen={Boolean(downloadModalSong)}
